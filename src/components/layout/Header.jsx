// Header simplifié pour ALMAS & MIDAS - Version Demo Académique
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <Link to="/" className="flex items-center space-x-3 group flex-shrink-0">
            ...
            >
              <Diamond className="w-8 h-8 text-purple-600 group-hover:text-blue-600 transition-colors" />
              <motion.div
                className="absolute inset-0 bg-purple-600/20 rounded-full opacity-20 blur-xl"
          ...
          <div className="flex items-center space-x-4">
            {/* VENDEZ VOS BIJOUX CTA Button */}
            <div className="hover-card">
              <Link
                to="/vendez-vos-bijoux"
                className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white px-4 py-2 rounded-full font-semibold text-sm transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl whitespace-nowrap"
              >
                VENDEZ VOS BIJOUX
              </Link>
            </div>
              ...
              <form onSubmit={handleSearch} className="relative">
                ...
                >
                  ...
                  <input
                    ...
                    className="pl-9 pr-4 py-2 w-48 border border-gray-200 rounded-full focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-white/80 backdrop-blur-sm text-sm"
                  />
                </motion.div>
              </form>
            </div>
