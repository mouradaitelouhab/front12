      ...
      <section className="container mx-auto px-4 py-16">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
            Depuis 1999, ALMAS & MIDAS perpétue l'art ancestral de la joaillerie marocaine 
          ...
          >
            ...
            <div className="space-y-6 text-muted-foreground">
              <p>
                ...
                ALMAS & MIDAS avec une vision claire : créer des bijoux d'exception qui racontent 
                une histoire.
              </p>
              <p>
